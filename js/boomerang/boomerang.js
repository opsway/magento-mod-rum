...
function formatBwLatency(testBandwidth, o) {
    if (testBandwidth) {
        bandwidth = ">10Mb"; 
        pre_bw = o.bw/1000;
	    ...
	    if (pre_bw <= 64) {
	        bandwidth = "<64Kb";
	    } else if (pre_bw > 64 && pre_bw <= 512) {
	        bandwidth = "64Kb-512Kb";
	    } else if (pre_bw > 512 && pre_bw <= 2048) {
	        bandwidth = "512Kb-2Mb";
	    } else if (pre_bw > 2048 && pre_bw <= 6000) {
	        bandwidth = "2Mb-6Mb";
	    } else if (pre_bw <= 10000) {
	        bandwidth = "6Mb-10Mb";
	    } 
	    ...
	    if (o.lat <= 50) {
	        latency = "<50ms";
	    } else if (o.lat > 50 && o.lat <= 100) {
	        latency = "50-100ms";
	    } else if (o.lat > 100 && o.lat <= 200) {
	        latency = "100-200ms";
	    } else if (o.lat > 200 && o.lat <= 400) {
	        latency = "200-400ms";
	    } else if (o.lat <= 1000) {
	        latency = "400-1000ms";
	    }
    } else {
        latency = "NA"; bandwidth = "NA";
    }
    return {
        latency: latency, 
        bandwidth: bandwidth
